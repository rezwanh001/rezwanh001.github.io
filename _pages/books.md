...
{% for book in page.reading_list %}
  <!-- Changed back to `col-md-4` for a 3-column layout -->
  <div class="col-md-4 mb-4 d-flex align-items-stretch">
    <div class="card w-100">
      ...
      <div class="card-body d-flex flex-column">
        ...
        <!-- Author name is now on its own line for a cleaner look -->
        <h6 class="card-subtitle mb-2 text-muted">{{ book.author }}</h6>
        <!-- Tags Section with updated styles -->
        <div class="tags-container mb-3">
          <!-- New, separate tag for the publication date -->
      ...
      <!-- Card Footer with Listen Button -->
